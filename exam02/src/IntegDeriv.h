...
class IntegDeriv {
    ...
    // integration methods
        void TrapezoidalRule(double xi, double xf, double& Integral,double step, double& Error);
        void simpsonRule(double xi, double xf, double& Integral, double& Error);
        void MidPoint(double xi, double xf, double& Integral,int step, double& Error);
